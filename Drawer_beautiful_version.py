...
def create_interactive_plot():
    ...
    plt.title('Geometry Drawer', y=1.03)
    plt.xlabel('x')
    plt.ylabel('y')
    ...
    def add_infinite_line(line_str):
        ...
        try:
            ...
            sizes = np.full(len(x_np), 5)
            scatter = plt.scatter(
                x_np, y_np, s=sizes, color=color,
                edgecolor='none', alpha=0.6, label=f"line {line_name1}{line_name2}"
            )
            inf_lines.append({
    ...
    def add_function(func_str):
        ...
        try:
            ...
            n_points = 2500 # how many points drawn 
