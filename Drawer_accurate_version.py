...
X_LIMIT = 100 #this is the only difference between beautiful version.
Y_LIMIT = 10
...
def create_interactive_plot():
    ...
    colors = [
        ...
        "#D94F70", "#8F4B1E", "#2B3E2E", "#A3A948", "#5D1451", "#4B5320", "#8B0000"
        "#000080", "#008080", "#800080", "#808000", "#FFA500", "#FFC0CB", "#FFD700",
